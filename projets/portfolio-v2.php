    ...
    <main class="transitionMode unprojet">
        <section class="presentaionProjet">
            ...
            <div class="presentaionProjetLien">
                <a href="http://perso.univ-lemans.fr/~i191251/portfolio_v2.3/" target="_blank">Voir le site (vous êtes déjà dessus)</a>
            </div>

        </section>

        <section class="galerie">
            <img src="projets/web-portfolio-v2/portfolio-v2_Mockup-1.jpg" alt="image d'illustsration">
