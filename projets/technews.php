...
<body>
    ...
    <main class="transitionMode unprojet">
        <section class="presentaionProjet">
            ...
            <h2>TechNews</h2>
            <ul class="tags">
                <li><a href="index.php?theme=graphisme" class="boutonTag">Graphisme</a></li>
                <li>2020</li>
                <li>IUT</li>
                <li>Mise-en-page</li>
                <li>PAO</li>
        ...
        <section class="galerie">
            <img src="projets/graphisme-technews/Magazine-Apple-page-2-3.jpg" alt="image d'illustsration" title="Pages 2 et 3">
